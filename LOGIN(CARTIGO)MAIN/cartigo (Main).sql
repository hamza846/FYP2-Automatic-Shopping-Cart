...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2019 at 02:07 PM
...
--
ALTER TABLE `bill`
  ADD PRIMARY KEY (`RFID_TAG`),
  ADD UNIQUE KEY `S.NO#` (`S.NO#`),
  ADD UNIQUE KEY `BILL_ID` (`BILL_ID`,`CART_ID`);
...
--
ALTER TABLE `cart`
  ADD PRIMARY KEY (`CART-ID`,`TOTAL-COST`,`DATE/TIME`),
  ADD UNIQUE KEY `CART-ID` (`CART-ID`);
...
ALTER TABLE `customer-cart`
  ADD PRIMARY KEY (`CART_ID`,`RFID_TAG`),
  ADD UNIQUE KEY `CART_ID` (`CART_ID`);
